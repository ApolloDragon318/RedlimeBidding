...
export default function AdminClientsProfiles({ isOpsLead = false } = {}) {
  ...
  const teamBMs = useMemo(() => bidManagers, [bidManagers])
      ...
      {profiles.length === 0 ? (
        <div className="card">
          <div className="empty-state-box">
            ...
            <p>{isOpsLead ? 'No unassigned or team profiles right now.' : 'No profiles yet.'}</p>
          </div>
        </div>
      ) : (
